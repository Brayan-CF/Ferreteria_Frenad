...
return [
    ...
    'description' => 'API REST para el sistema de gestión de Ferretería Frenat. Incluye módulos de autenticación, productos, inventario, ventas, compras, clientes y reportes.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenga su token en <code>POST /api/auth/auth/login</code> con email y password. El token debe enviarse en el header Authorization como: <code>Bearer {token}</code>',
    ],
